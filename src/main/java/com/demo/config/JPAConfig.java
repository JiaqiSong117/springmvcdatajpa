...
// in order to inject relevant code at runtime. //@EnableTransactionManagement: this tells Spring Data JPA to generate code for transaction management at runtime.
...
public class JPAConfig {
    ...
    public LocalEntityManagerFactoryBean entityManagerFactory() {
        LocalEntityManagerFactoryBean factoryBean = new LocalEntityManagerFactoryBean(); factoryBean.setPersistenceUnitName("PokemonDB");
        return factoryBean;
    }
